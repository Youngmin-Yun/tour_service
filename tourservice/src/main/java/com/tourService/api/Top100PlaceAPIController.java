...
import com.tourService.service.Top100PlaceService;
...
@RestController
public class Top100PlaceAPIController {
    @Autowired
    Top100PlaceService service;
    ...
    public Map<String, Object> insertTop100PlaceInfo()throws Exception{
        ...
        for(int i = 0; i < nList.getLength(); i++){
            ...
            Top100PlaceVO vo = new Top100PlaceVO();
            ...
            service.insertTop100PlaceInfo(vo);
        }
